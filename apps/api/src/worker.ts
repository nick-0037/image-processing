...
import { getFromS3, uploadToS3 } from './services/s3Service.js';
import { applyImageTransformations } from './services/imageService.js';
...
async function startWorker() {
    try {
        ...
        channel.consume(QUEUE, async (msg) => {
            ...
            const { imageId, originalKey, transformations, cacheKey, userId } = JSON.parse(
